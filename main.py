...
def parse_args():
    ...
    parser.add_argument('--algorithm', type=str, default='DCFCL',
                        choices=['DCFCL', 'CollEdge', 'FedAvg', 'FedProx', 'FedLwF', 'Local', 
    ...
    parser.add_argument('--use_der', action='store_true', default=True,
                        help='Enable DER++ replay module for CollEdge (master switch)')
    parser.add_argument('--no_use_der', dest='use_der', action='store_false',
                        help='Disable DER++ replay module (ablation: CollEdge → DCFCL behavior)')
    parser.add_argument('--buffer_size', type=int, default=500,
                        help='Replay buffer size per client (CollEdge)')
    parser.add_argument('--der_alpha', type=float, default=0.5,
                        help='DER logit-matching loss weight (CollEdge)')
    parser.add_argument('--der_beta', type=float, default=0.5,
                        help='DER++ replay CE loss weight (CollEdge)')
