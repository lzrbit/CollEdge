#!/usr/bin/env bash
# ==============================================================
# 01_baselines_emnist.sh
# Purpose : 在 EMNIST-Letters 上运行所有 baseline 算法
# Algorithms: Local / FedAvg / FedProx / FedLwF / SCAFFOLD
#             PerAvg / pFedMe / ClusterFL  (共 8 个)
# Results : results/paper_experiments/baselines/EMNIST-Letters/
# Usage   : bash scripts/paper_experiments/01_baselines_emnist.sh
# ==============================================================

REPO="$(cd "$(dirname "${BASH_SOURCE[0]}")/../.." && pwd)"
cd "$REPO"

RESULT_BASE="results/paper_experiments/baselines/EMNIST-Letters"
...
_log "=== START 01_baselines_emnist.sh ==="
...
_log "=== END 01_baselines_emnist.sh ==="
